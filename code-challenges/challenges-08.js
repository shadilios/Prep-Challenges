...
const customerAndAge = (obj) => {
  ...
  let array =[];
  // Loop through all of the items in the object
  for(let key in obj){
    // For each item, construct a string with the data and push it onto the array.
    let newString ="Customer Name :"+ key + " , Age :" + obj[key];
    array.push(newString);
  }
  // Return the array YA 7MAR!
  return array;
